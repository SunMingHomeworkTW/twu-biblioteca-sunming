...
public class Hint {
    ...
    public static final String MOVIE_FORMAT="%-8d%-40s%-8s%-20s%-8s";
    public static final String MOVIELIST_HEAD =String.format("%-8s%-40s%-8s%-20s%-8s","Id","Name","Year","Director","Rating");
    ...
    public static final String LOGIN_UNSUCCESSFUL="Your library number and password are invalid.Input again or not?(Y/N)\n";
